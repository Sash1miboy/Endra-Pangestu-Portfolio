        ...
        <div className="container">
          ...
          <div className="descAboutMe">
            <div className="descPart">
              <span className="part1">I am an undergraduate student at BINUS University, majoring in Computer Science with a passion for web development. My expertise is in front-end development where i am proficient in HTML, CSS, JavaScript, React.js, and UI/UX Design. I'm also familiar with back-end development like node.js, express.js, MongoDB, and MySQL and I'm continually learning more about software development.</span>
